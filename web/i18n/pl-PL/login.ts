const translation = {
  ...
  welcome: 'Witaj w  PTMIND.AI, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej  PTMIND.AI, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na  PTMIND.AI',
  invalid: 'Link wygasł',
  explore: 'Odkryj  PTMIND.AI',
