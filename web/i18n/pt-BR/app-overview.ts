const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ou experimente a versão em nuvem do  PTMIND.AI com cota gratuita',
  },
  overview: {
    title: 'Visão Geral',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajuda os visitantes a entender os dados coletados pelo aplicativo, consulte a <privacyPolicyLink>Política de Privacidade</privacyPolicyLink> do  PTMIND.AI.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalar a Extensão do Chrome  PTMIND.AI Chatbot',
        copied: 'Copiado',
        copy: 'Copiar',
      },
      qrcode: {
