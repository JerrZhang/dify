const translation = {
  ...
  welcome: 'Bine ai venit la  PTMIND.AI, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe  PTMIND.AI Community Edition, citește',
    link: 'Licența open-source de pe GitHub',
  },
  join: 'Alătură-te',
  joinTipStart: 'Te invităm să te alături echipei',
  joinTipEnd: 'pe  PTMIND.AI',
  invalid: 'Link-ul a expirat',
  explore: 'Explorează  PTMIND.AI',
