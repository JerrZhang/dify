const translation = {
  ...
  welcome: 'Bienvenue sur  PTMIND.AI, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer  PTMIND.AI Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur  PTMIND.AI',
  invalid: 'Le lien a expiré',
  explore: 'Explorez  PTMIND.AI',
