const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Ou essayez la version cloud de  PTMIND.AI avec un devis gratuit',
  },
  overview: {
    title: 'Aperçu',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Aide les visiteurs à comprendre les données collectées par l\'application, voir la <privacyPolicyLink>Politique de confidentialité</privacyPolicyLink> de  PTMIND.AI.',
      ...
      embedded: {
        ...
        chromePlugin: 'Installer l\'extension Chrome  PTMIND.AI Chatbot',
        copied: 'Copié',
        copy: 'Copier',
      },
      qrcode: {
