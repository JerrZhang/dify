const translation = {
  ...
  welcome: 'Chào mừng bạn đến với  PTMIND.AI, vui lòng đăng nhập để tiếp tục.',
  email: 'Địa chỉ Email',
  ...
  license: {
    tip: 'Trước khi bắt đầu Phiên bản Cộng đồng của  PTMIND.AI, hãy đọc',
    link: 'Giấy phép mã nguồn mở trên GitHub',
  },
  join: 'Tham gia',
  joinTipStart: 'Mời bạn tham gia',
  joinTipEnd: 'đội tại  PTMIND.AI',
  invalid: 'Liên kết đã hết hạn',
  explore: 'Khám phá  PTMIND.AI',
