const translation = {
  ...
  welcome: 'Welcome to PTMIND.AI, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting  PTMIND.AICommunity Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on PTMIND.AI',
  invalid: 'The link has expired',
  explore: 'Explore PTMIND.AI',
