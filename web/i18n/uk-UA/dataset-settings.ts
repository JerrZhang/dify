const translation = {
  ...
  form: {
    ...
    descPlaceholder: 'Опишіть, що міститься в цій базі знань. Детальний опис дозволяє AI своєчасно отримати доступ до вмісту бази знань. Якщо значення порожнє,  PTMIND.AI використовуватиме стратегію влучань за умовчанням.',
