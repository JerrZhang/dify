const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Або спробуйте хмарну версію  PTMIND.AI з безкоштовним цитатою',
  },
  overview: {
    title: 'Огляд',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Допомагає відвідувачам зрозуміти дані, зібрані додатком, див. <privacyPolicyLink>Політику конфіденційності</privacyPolicyLink>  PTMIND.AI.',
      ...
      embedded: {
        ...
        chromePlugin: 'Встановити розширення Chrome  PTMIND.AI Chatbot',
        copied: 'Скопійовано',
        copy: 'Скопіювати',
      },
      qrcode: {
