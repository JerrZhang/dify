const translation = {
  ...
  welcome: 'Ласкаво просимо до  PTMIND.AI, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском  PTMIND.AI Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда  PTMIND.AI',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте  PTMIND.AI',
